...
function dessinerSimulationVisuelle()
    ...
    z = -1/C*(A*x + B*y + D); 
    %table verte
    patch([1.525 0 0 1.525], [2.74 2.74 0 0], [0.76 0.76 0.76 0.76], [0  0.5  0]);
    %filet jaune 0.9125
    patch([-0.1525 1.6775 1.6775 -0.1525], [1.37 1.37 1.37 1.37], [0.76  0.76 0.9125 0.9125], [0.8 0.8 0]);
