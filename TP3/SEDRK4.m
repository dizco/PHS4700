function qs = SEDRK4t0(q0, t0, Deltat, g, auto)
...
k1 = feval(g, q0, t0, auto);
k2 = feval(g, q0 + k1 * Deltat / 2, t0 + Deltat / 2, auto);
k3 = feval(g, q0 + k2 * Deltat / 2, t0 + Deltat / 2, auto);
k4 = feval(g, q0 + k3 * Deltat, t0 + Deltat, auto);
